Pod::Spec.new do |s|
  ...
  s.ios.vendored_frameworks = 'ROXCore.xcframework'
  s.tvos.vendored_frameworks = 'ROXCore.xcframework'

  s.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '$(inherited)' }

  s.source       = { :git => "https://github.com/rollout/rox-ios-core.git", :tag => "4.10.16" }
